...
namespace _0_Framework.Application
{
    public static class PasswordGenerator
    {
        ...
        public static string GeneratePassword(bool includeLowercase, bool includeUppercase, bool includeNumeric, int lengthOfPassword)
        {
            ...
            {
                return "طول کلمه عبور باید بین 8 تا 128 کاراکتر باشد.";
            }
        ...
        public static bool PasswordIsValid(bool includeLowercase, bool includeUppercase, bool includeNumeric, string password)
        {
            ...
            return lowerCaseIsValid && upperCaseIsValid && numericIsValid;
        }
    }
}
